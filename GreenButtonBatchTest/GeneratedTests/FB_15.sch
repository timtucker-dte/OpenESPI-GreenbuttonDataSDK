...
<sch:pattern name="/atom:feed">
     <sch:rule context="/atom:feed">
         <sch:assert test="atom:entry[*/espi:ElectricPowerUsageSummary | */espi:UsageSummary]" diagnostics="for future use">
...
<sch:pattern name="/atom:feed/atom:entry/atom:content[espi:ElectricPowerUsageSummary | espi:UsageSummary]/child::*">
     <sch:rule context="/atom:feed/atom:entry/atom:content[espi:ElectricPowerUsageSummary | espi:UsageSummary]/child::*">
         <sch:assert test="espi:billingPeriod/espi:duration" diagnostics="for future use">
             D089|ElectricPowerUsageSummary billingPeriod duration|verify the presence of a valid value
         </sch:assert>
         <sch:assert test="espi:billingPeriod/espi:start" diagnostics="for future use">
             D090|ElectricPowerUsageSummary billingPeriod start|verify the presence of a valid value
         </sch:assert>
         <sch:assert test="espi:overallConsumptionLastPeriod" diagnostics="for future use">
             D081|ElectricPowerUsageSummary overallConsumptionLastPeriod|verify the presence of a valid value
         </sch:assert>
         <sch:assert test="espi:qualityOfReading" diagnostics="for future use">
             D099|ElectricPowerUsageSummary qualityOfReading|verify the presence of a valid value
         </sch:assert>
         <sch:assert test="espi:statusTimeStamp" diagnostics="for future use">
             D100|ElectricPowerUsageSummary statusTimeStamp|verify the presence of a valid value
         </sch:assert>
     </sch:rule>
</sch:pattern>
<sch:pattern name="/atom:feed/atom:entry/atom:content[espi:UsageSummary | espi:ElectricPowerUsageSummary]/child::*/espi:currentBillingPeriodOverAllConsumption">
     <sch:rule context="/atom:feed/atom:entry/atom:content[espi:UsageSummary | espi:ElectricPowerUsageSummary]/child::*/espi:currentBillingPeriodOverAllConsumption">
         <sch:assert test="espi:powerOfTenMultiplier" diagnostics="for future use">
